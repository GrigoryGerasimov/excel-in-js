...
import { ToolbarEventHandlers } from "@/app/class.components/Toolbar/ToolbarEventHandlers";
import { HeaderEventHandlers } from "@/app/class.components/Header/HeaderEventHandlers";
...
export const ComponentsEventHandlers = {
    ...
    Header: HeaderEventHandlers,
    Toolbar: ToolbarEventHandlers
};
