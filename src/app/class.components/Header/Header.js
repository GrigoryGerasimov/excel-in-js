...
<div class="header-wrapper">
    ...
    <div class="app-header__btn-icon-group">
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="app-header__btn-icon">
...
export const Header = new ComponentFactory(ExcelComponent, "app-header", HeaderTemplate, "Header", ["input"], ["sheetName"]);
...
Header.prototype.initSubscription = function() {
    ...
    if (isInStorage(localStorageKeys.EXCEL_TABLE_STATE)) {
        this.$rootElem.findOne("#sheetName").value = getFromStorage(localStorageKeys.EXCEL_TABLE_STATE).sheetName;
    }
};
